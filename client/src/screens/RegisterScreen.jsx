...
const RegisterScreen = () => {
    ...
    return (
        <Box className="screen" sx={{ height: "77vh", border: "1px solid, black" }}>
            <Box 
            sx={{ position: "relative", top: 210, left: 210, display: "flex", flexDirection: "column", alignItems: "center", width: "fit-content", justifyContent: "center" }}>
